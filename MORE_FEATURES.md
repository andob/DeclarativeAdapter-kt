...
```
dependencies {
    implementation 'ro.andob.declarativeadapter:adapter-kt:1.3.0.6'
    implementation 'ro.andob.declarativeadapter:sticky-headers:1.3.0.6'
}
```
...
dependencies {
    implementation 'ro.andob.declarativeadapter:adapter-kt:1.3.0.6'
    implementation 'ro.andob.declarativeadapter:viewbinding-compat:1.3.0.6'
}
```
